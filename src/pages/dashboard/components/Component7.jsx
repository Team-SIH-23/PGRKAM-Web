...
import { Box, VStack, FormControl,FormLabel, Input, Button,Select ,Text } from "@chakra-ui/react";
const Component7 = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      <Box border="1px solid orange" borderTop="10px solid orange" p="20px" width="800px" margin="auto" position="relative">
